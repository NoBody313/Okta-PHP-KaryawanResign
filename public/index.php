...
if (isset($_REQUEST['dashboard']) && (isset($_SESSION['username']))) {
    view('dashboard');
    die();
}

if (isset($_REQUEST['dataKaryawan']) && (isset($_SESSION['username']))) {
    view('dataKaryawan');
    die();
}

if (isset($_REQUEST['listKaryawan']) && (isset($_SESSION['username']))) {
    view('listKaryawan');
    die();
}

if (isset($_REQUEST['listEditKaryawan']) && (isset($_SESSION['username']))) {
    view('listEditKaryawan');
    die();
}

if (isset($_REQUEST['sidebar']) && (isset($_SESSION['username']))) {
    view('sidebar');
    die();
}
