<aside
    ...
    <div class="flex flex-col justify-between items-center flex-1 mt-6">
        <nav>
            <a class="flex items-center px-4 py-2 rounded-md bg-gray-800 text-gray-200" href="/views/dashboard.php">
            ...
            <a class="flex items-center px-4 py-2 mt-5 text-gray-400 transition-colors duration-300 transform rounded-md hover:bg-gray-800 hover:text-gray-200 active:bg-gray-800 active:text-gray-200 hover:fill-current"
                ...
                class="flex items-center px-4 py-2 mt-5 text-gray-400 transition-colors duration-300 transform rounded-md hover:bg-gray-800 hover:text-gray-200 active:bg-gray-800 active:text-gray-200 hover:fill-current"
